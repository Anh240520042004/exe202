...
import { register, clearError, setCredentials } from "../../store/slices/authSlice";
    ...
    onSuccess: async (tokenResponse) => {
      try {
        const { data } = await axios.post(`${API_URL}/api/auth/google`, {
          idToken: tokenResponse.token_id,
        });
        if (data.success) {
          dispatch(setCredentials(data.data));
          toast.success(data.message || 'Đăng ký Google thành công!');
          navigate('/dashboard');
        }
      } catch (err) {
